...
from .views import create_job, list_jobs, fetch_filtered_jobs, fetch_job_detail, update_job, delete_job, apply_for_job, track_applications, schedule_interview, create_job_seeker_profile, fetch_job_seeker_profile, update_job_seeker_profile
...
urlpatterns = [
    ...
    path('api/job-seekers/<int:seeker_id>', fetch_job_seeker_profile, name='fetch_job_seeker_profile'),
